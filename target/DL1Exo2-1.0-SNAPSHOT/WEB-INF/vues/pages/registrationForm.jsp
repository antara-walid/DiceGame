                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form id="form1" class="mx-1 mx-md-4" action="${pageContext.request.contextPath}/RegistrationServlet" method="post">
                                    ...
                                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                        <button type="submit" form="form1"  value="Submit" class="btn btn-primary btn-lg">Register</button>
